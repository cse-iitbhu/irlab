    ...
    <div className='font-serif text-[#666666]' data-aos-duration="1200" data-aos="zoom-in">
      ...
      <div className='my-[2%]  px-[8%]'>
        <div className='flex flex-col'>
          ...
          {filter&& <div className='teaching-content px-[1%] flex justify-between my-[2%] text-[120%] '>
            <div className='w-[30%] flex  '>{filter[0].name}</div>
            <div className='w-[30%] flex  '>{filter[0].year}</div>
            <div className='w-[30%] flex '>
              <a target='__blank' className='hover:underline text-[#67b0d1]' href={filter.url}>  Google Classroom </a></div>
          </div>}
