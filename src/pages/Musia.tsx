...
const timeline = [
  ...
  ["08 August 2026", "Subtask 1 & 2 Submission Deadline"],
  ["08 August 2026", "Subtask 3 Test Release"],
  ["20 Aug 2026", "Subtask 3 Submission Deadline"],
  ["31 Aug 2026", "Results Announcement"],
  ["15 Sep 2026", "Working Notes Due"],
...
<section className="max-w-7xl mx-auto px-6 pb-24">
  ...
  <div className="grid lg:grid-cols-3 gap-8">
    ...
    <div className="group bg-white dark:bg-gray-800 rounded-3xl shadow-lg p-8 flex flex-col border border-transparent hover:border-blue-500 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
      ...
      {/* DATASET */}
      <section className="bg-white dark:bg-gray-800 px-6 py-8">
...
<section className="max-w-4xl mx-auto px-6 py-16">
  ...
  <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl bg-white dark:bg-gray-800">
    <table className="w-full">
      ...
      {/* ORGANIZERS */}
        <section className="bg-white dark:bg-gray-900 px-6 py-8">
        <div className="max-w-7xl mx-auto px-6">
...
{/* LEFT PANEL */}
<div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-[#1D439C] via-[#12497F] to-[#084F63] text-white p-8 md:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.25)] flex flex-col justify-between">
  ...
  <div className="relative z-10">
    ...
    <p className="text-lg md:text-xl text-blue-100 leading-relaxed max-w-2xl">
      Begin your MUSIA 2026 journey by completing your registration.
       Once registered, join our official WhatsApp community
       to stay informed about important deadlines, dataset releases, results, and workshop updates.
    </p>
    ...
    <div className="flex items-center gap-4 my-8">
      ...
      <span className="text-white/60 text-xs uppercase tracking-[4px]">
        Community
      </span>
  ...
  Already registered? Join the WhatsApp community below.
</p>
    ...
    {/* WhatsApp CTA */}
    <a
      href="https://chat.whatsapp.com/G448vLCPwWx088MdtdLrJa?s=sh&p=a&ilr=1"
      className="
        group
    ...
    >
      ...
      <div>
        ...
        <p className="text-blue-100 mt-1">
          Get announcements, deadlines and results instantly
        </p>
      </div>
...
<div className="mb-2 border-b border-sky-200 dark:border-slate-700 pb-2">
